		...
		<div class="row">
			...
			<div class="span7" style="border-left: 1px solid #ccc;margin-left: -2px;">
				<table class="table table-bordered" style="width: 95%;margin-top: 100px;float: right;">
					...
					<tr>
						<td colspan="2"
							style="background-color: #dff0d8; text-align: center;"><strong>&nbsp;高等教育出版社图书商城后台系统</strong>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<form action="${request.getContextPath }/boss/doLogin" theme="simple" type="post" cssClass="form-horizontal">
